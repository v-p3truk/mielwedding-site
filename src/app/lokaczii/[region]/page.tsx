...
export async function generateMetadata({ params }: PageProps) {
  ...
  return {
    title: `${region.title} — Miel Wedding`,
      ...
      <section className="py-16 bg-cream-light">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">{region.title}</h1>
            <p className="text-lg text-dark-light">{region.description}</p>
          </div>
        </div>
      </section>
                ...
                >
                  <div className="h-48 bg-cream relative">
                    <div className="absolute inset-0 flex items-center justify-center">
                      <MapPin className="h-12 w-12 text-dark/20" />
                    </div>
                  </div>
                  <div className="p-6">
                    ...
                    <p className="text-dark-light text-sm mb-3">{venue.description}</p>
                    {venue.price && (
