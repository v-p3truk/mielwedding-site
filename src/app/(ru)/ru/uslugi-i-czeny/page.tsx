          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service) => (
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="text-xl font-semibold mb-2">{service.title.ru}</h3>
                  <p className="text-dark-light text-sm mb-4">{service.description.ru}</p>
                  <ul className="space-y-2 mb-4">
                    {service.features.ru.slice(0, 3).map((feature, index) => (
